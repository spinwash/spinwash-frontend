...
const SearchData = [
  ...
  {
    name: 'Service Wash (Wash, Dry & Fold) 5kg or Above',
    price: '£3.50 per kg ',
    parentId: 'Laundry',
    id: 66,
  },
  ...
  {
    name: 'Single Bed Set - 1 Single Duvet Cover, 1 Single Sheet, 2 Pillow Cases ',
    price: '£13.50',
    parentId: 'Bedding',
    id: 75,
  },
  {
    name: 'Double Bed Set - 1 Double Duvet Cover, 1 Double Sheet, 2 Pillow Cases ',
    price: '£17.50',
    parentId: 'Bedding',
    id: 76,
  },
  {
    name: 'King Bed Set - 1 King Duvet Cover, 1 King Sheet, 2 Pillow Cases  - 1 King Sheet, 1 King Duvet Cover, 2 Pillow Cases( wash and Press )',
    price: '£19.50',
    parentId: 'Bedding',
    id: 77,
  },
  {
    name: 'Super King Bed Set - 1 Super King Duvet Cover, 1 Super King Sheet, 2 Pillow Cases  - 1 King Duvet Cover, 1 King Sheet, 2 Pillow Cases ',
    price: '£21.50',
    parentId: 'Bedding',
    id: 78,
  },
  ...
  {
    name: 'Silk Bed set (Single)- 1 Silk Single Sheet, 1 Silk Single Duvet Cover, 2 Silk Pillow Cases',
    price: '£19.95',
    parentId: 'Bedding',
    id: 108,
  },
  {
    name: 'Silk Bed set (Double)- 1 Silk Double Sheet, 1 Silk Double Duvet Cover, 2 Silk Pillow Cases',
    price: '£24.95',
    parentId: 'Bedding',
    id: 109,
  },
  {
    name: 'Silk Bed set (King)- 1 Silk King Sheet, 1 Silk King Duvet Cover, 2 Silk Pillow Cases',
    price: '£26.95',
    parentId: 'Bedding',
    id: 110,
  },
  {
    name: 'Silk Bed set (Super King)- 1 Silk Super King Sheet, 1 Silk Super King Duvet Cover, 2 Silk Pillow Cases',
    price: '£28.95',
    parentId: 'Bedding',
    id: 111,
  },
  ...
  {
    name: 'Two-Piece Suit (Press Only)',
    price: '£9.95',
    parentId: 'Ironing Only',
    id: 128,
  },
  {
    name: 'Three Piece Suit (Press Only)',
    price: ' £12.50',
    parentId: 'Ironing Only',
    id: 129,
  },
  {
    name: 'Dinner Suit/ Tuxedo (Press Only)',
    price: '£11.50',
    parentId: 'Ironing Only',
    id: 130,
  },
  {
    name: 'Dinner Jacket (Press Only)',
    price: '£7.50',
    parentId: 'Ironing Only',
    id: 131,
  },
  {
    name: 'Dinner Trouser (Press Only)',
    price: '£4.95',
    parentId: 'Ironing Only',
    id: 132,
  },
  {
    name: 'Dress Suit (Press Only)',
    price: '£13.50',
    parentId: 'Ironing Only',
    id: 133,
  },
  {
    name: 'Dress (Press Only)',
    price: 'From £8.95',
    parentId: 'Ironing Only',
    id: 134,
  },
  {
    name: 'Skirt (Press Only)',
    price: 'From £4.95',
    parentId: 'Ironing Only',
    id: 135,
  },
  {
    name: 'Trouser (Press Only)',
    price: '£3.95',
    parentId: 'Ironing Only',
    id: 136,
  },
  {
    name: 'Jeans (Press Only)',
    price: '£3.95',
    parentId: 'Ironing Only',
    id: 137,
  },
  {
    name: 'Shorts (Press Only)',
    price: '£3.95',
    parentId: 'Ironing Only',
    id: 138,
  },
  {
    name: 'Men’s Shirt (Press Only)',
    price: '£1.95',
    parentId: 'Ironing Only',
    id: 139,
  },
  {
    name: 'Ladies Shirt (Press Only)',
    price: '£2.95',
    parentId: 'Ironing Only',
    id: 140,
  },
  {
    name: 'Jacket/ Blazer (Press Only)',
    price: '£6.50',
    parentId: 'Ironing Only',
    id: 141,
  },
  {
    name: 'Jacket - Silk (Press Only)',
    price: '£6.95',
    parentId: 'Ironing Only',
    id: 142,
  },
  {
    name: 'Light Knitwear (Press Only)',
    price: '£4.50',
    parentId: 'Ironing Only',
    id: 143,
  },
  {
    name: 'Heavy Knitwear (Press Only)',
    price: '£5.50',
    parentId: 'Ironing Only',
    id: 144,
  },
  ...
  {
    name: 'Coat (Press Only)',
    price: 'From £8.95',
    parentId: 'Ironing Only',
    id: 150,
  },
  {
    name: 'Waistcoat (Press Only)',
    price: '£3.95',
    parentId: 'Ironing Only',
    id: 151,
  },
  {
    name: 'Rain Coat / Mac (Press Only)',
    price: 'From £10.50',
    parentId: 'Ironing Only',
    id: 152,
  },
  {
    name: 'Polo T-shirt (Press Only)',
    price: '£3.50',
    parentId: 'Ironing Only',
    id: 153,
  },
  {
    name: 'T-shirt (Press Only)',
    price: '£2.95',
    parentId: 'Ironing Only',
    id: 154,
  },
  {
    name: 'Jumpsuit (Press Only)',
    price: '£8.50',
    parentId: 'Ironing Only',
    id: 155,
  },
  {
    name: 'Tracksuit (Press Only)',
    price: '£8.95',
    parentId: 'Ironing Only',
    id: 156,
  },
  {
    name: 'Tracksuit Top (Press Only)',
    price: '£4.95',
    parentId: 'Ironing Only',
    id: 157,
  },
  {
    name: 'Tracksuit Bottom (Press Only)',
    price: '£3.95',
    parentId: 'Ironing Only',
    id: 158,
  },
